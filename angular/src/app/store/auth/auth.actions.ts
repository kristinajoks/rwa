...
export const loginUserSuccess = createAction('[Auth] Login User Success', props<{userId: number, token: string}>());
...
export const signupUserSuccess = createAction('[Auth] Signup User Success', props<{userId: number, token: string}>());
